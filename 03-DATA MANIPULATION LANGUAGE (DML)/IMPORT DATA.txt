...
11/01/2022  09:45 PM    <DIR>          xampp
               ...
               8 Dir(s)  147,885,907,968 bytes free
...
03/30/2013  07:29 PM           118,784 xampp_stop.exe
              ...
              24 Dir(s)  147,885,842,432 bytes free
...
05/18/2022  06:31 AM            86,263 THIRDPARTY
               ...
               7 Dir(s)  147,885,711,360 bytes free
...
MariaDB [toko]> SHOW TADABASES;
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'TADABASES' at line 1
MariaDB [toko]> SHOW DATABASES;
+--------------------+
| Database           |
+--------------------+
| classicmodels      |
...
MariaDB [toko]> USE classicmodels;
Database changed
MariaDB [classicmodels]> DROP DATABASE classicmodels;
Query OK, 8 rows affected (0.120 sec)
...
MariaDB [(none)]> SOURCCE C:\Users\lenovo\Documents\myclass dinda\SQL\03-DATA MANIPULATION LANGUAGE (DML)\mysqlsampledatabase\mysqlsampledatabase.sql
...
ERROR: Unknown command '\m'.
    -> ;
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'SOURCCE C:\Users\lenovo\Documents\myclass dinda\SQL\03-DATA MANIPULATION LANG...' at line 1
MariaDB [(none)]> CREATE DATABASE classicmodels;
Query OK, 1 row affected (0.001 sec)

MariaDB [(none)]> USE classicmodels;
Database changed
MariaDB [classicmodels]> SOURCE C:\Users\lenovo\Documents\myclass dinda\SQL\03-DATA MANIPULATION LANGUAGE (DML)\mysqlsampledatabase\mysqlsampledatabase.sql
...
Query OK, 122 rows affected (0.008 sec)
...
Query OK, 23 rows affected (0.003 sec)
...
Query OK, 2996 rows affected (0.043 sec)
...
Query OK, 326 rows affected (0.008 sec)
...
Query OK, 273 rows affected (0.007 sec)
...
Query OK, 110 rows affected (0.009 sec)
...
MariaDB [classicmodels]> SELECT*FROM customers;
+----------------+------------------------------------+-----------------+------------------+--------------------+----------------------------------+--------------------------+-------------------+---------------+------------+--------------+------------------------+-------------+
...
MariaDB [classicmodels]> SELECT*FROM employees;
+----------------+-----------+-----------+-----------+---------------------------------+------------+-----------+----------------------+
...
MariaDB [classicmodels]> SELECT*FROM orderdetails;
+-------------+-------------+-----------------+-----------+-----------------+
...
MariaDB [classicmodels]> SELECT*FROM orders;
+-------------+------------+--------------+-------------+------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+----------------+
...
MariaDB [classicmodels]> SELECT*FROM payments;
+----------------+-------------+-------------+-----------+
...
MariaDB [classicmodels]> SELECT*FROM produclines;
ERROR 1146 (42S02): Table 'classicmodels.produclines' doesn't exist
MariaDB [classicmodels]> SELECT*FROM productlines;
+------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-----------------+-------+
...
| S32_1268    | 1980ΓÇÖs GM Manhattan Express               | Trucks and Buses | 1:32         | Motor City Art Classics   | This 1980ΓÇÖs era new look Manhattan express is still active, running from the Bronx to mid-town Manhattan. Has 35 opeining windows and working lights. Needs a battery.                                                                                                                                                                                                                                                                                                                                        |            5099 |    53.93 |  96.31 |
...
MariaDB [classicmodels]> SHOW DATABASE;
...
MariaDB [classicmodels]> USE toko;
Database changed
...
MariaDB [toko]> CREATE TABLE customers (
    -> customerId INT AUTO_INCREMENT PRIMARY KEY
    -> ,
    -> custommerName VARCHAR(50) NOT NULL,
    -> ;
